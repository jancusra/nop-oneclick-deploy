...
3. define some custom items (files or folders) to back up in the list variable **$itemsToBackupCopy**
4. define some large folders to back up by moving the folder in the list variable **$itemsToBackupMove**  
5. **run deploy script as administrator, following tasks will be executed:**  
   ...
   5. backed up items will be restored (existing files will be replaced by the backed up ones)
